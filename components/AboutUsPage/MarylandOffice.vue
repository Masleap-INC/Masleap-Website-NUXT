<template>
    ...
    <section>
        ...
        <div class="lg:grid lg:grid-cols-2 py-20">

            <!-- Column 1 -->

            <div class=" mx-auto self-center md:mb-20 sm:mb-20">

                <h2 class="lg:w-2/3 md:w-5/6 sm:w-5/6 mx-auto">
                    <span class="block text-cyan-500 text-4xl font-semibold mb-10">Maryland, USA</span>
                    <span class="block text-2xl"><b>Address:</b><br> Buckeystown Pike, Frederick, MD, USA Suite 250 <br><br> <b>Phone:</b><br> +1 (301) 244-0147</span>
                </h2>
