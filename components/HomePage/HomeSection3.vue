<template>
  ...
  <section>
    <div class="bg-white">
      <div class="lg:w-2/3 mx-auto py-20 md:w-5/6 sm:w-5/6">
        <h2 class="mx-auto text-center">
          <span class="block text-4xl text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-500 font-bold mb-10">Our Proud Partners</span>
          <span class="block text-black text-2xl italic font-light">We work with startups, corporations, and nonprofits across a myriad of verticals, leveraging cutting-edge technologies to craft app and software solutions that make a real impact.</span>
        </h2>
      </div>

      <!-- Partners logo section 1 -->
