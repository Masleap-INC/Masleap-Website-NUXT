      ...
      <div class="lg:grid lg:grid-cols-2 lg:w-2/3 md:w-5/6 sm:w-5/6 mx-auto">
        ...
        >
          <h2 class="text-4xl font-bold text-white sm:mx-auto sm:justify-self-center w-full">
            ...
            >
            <span class="block pt-5 lg:pb-10 sm:pb-5 text-2xl italic font-light"
              >We analyze and provide the right solution with feasible
              maintenance and user-centric approach.</span
            >
